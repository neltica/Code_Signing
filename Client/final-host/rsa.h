...
long long *rsa_encrypt(const char *message, const unsigned long message_size, const struct private_key_class *priv);
...
char *rsa_decrypt(const long long *message, const unsigned long message_size, const struct public_key_class *pub);
